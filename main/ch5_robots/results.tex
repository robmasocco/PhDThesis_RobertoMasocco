...
The Contest environment required extended flights to complete full missions, with the quadcopter demonstrating endurance capabilities of up to $14$ minutes while covering a cumulative distance of $118$ meters. The presented data corresponds to the fourth of the four Contest runs. This particular execution involved an abbreviated exploration phase, transitioning to mission operations immediately upon robot detection to begin the search for the landing pads. \Cref{fig:ldc21run} illustrates the flight trajectory executed during the Contest run, during which five successful precision landings were achieved. The analysis of the collected results yielded RMSE measurements across the trajectory as detailed in \Cref{tab:ldc21run}. The $(x,y)$ planar error demonstrates good performance compared to laboratory testing, although the $z$ component has been estimated less accurately.
\begin{figure}[t!]
  \centering
