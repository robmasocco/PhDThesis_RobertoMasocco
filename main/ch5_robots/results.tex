...
\begin{subequations}
  ...
  \end{align}
\end{subequations}
The formulation presented in \eqref{eq:iccad23:blending} exhibits simplicity while incorporating several advantageous characteristics. The parameters $(\alpha_1,\dotsc,\alpha_n)$ enable fine-tuned calibration to accommodate varying levels of sensor accuracy and reliability. The responsiveness of the method to sensor operational states facilitates resilient operation during both transient and permanent sensor failures, as shown in the experimental validation discussed in \cite{bianchi_efficient_2023}. From a computational perspective, \eqref{eq:iccad23:blending} demonstrates high efficiency, as it reduces to a series of scalar products that can be executed with minimal computational overhead on standard microprocessor architectures.
