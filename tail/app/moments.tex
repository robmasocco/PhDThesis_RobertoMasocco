...
The contents of this Appendix are based on \cite{astolfi_model_2010,scarciotti_data-driven_2017} and references therein; some more insights are also found in \cite{carnevale_external_2017,carnevale_data_2021}. The interested reader is referenced to those works for a detailed discussion of the following topics. Consider the system
\begin{subequations}
...
$x_0=\Pi w_0$, then
\begin{align}
	x(t) &= \Pi w(t), & y(t) &= M w(t), & \forall t\geq0,
\end{align}
...
\begin{align}
  \label{eq:moments_exist_ss}
	\spec(A)&\subset\C_{<0}, & \spec(S)&\subset\C_{\geq0},
\end{align}
which ensures the existence of a steady-state response for
