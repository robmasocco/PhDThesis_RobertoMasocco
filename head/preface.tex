...
Given a function $f(x)$, $f : \R^n \rightarrow \R$, $\nabla f$ denotes its gradient as a column vector, whereas $\frac{\partial f}{\partial x}$ denotes its gradient as a row vector.
...
Let $t\in\R_{\geq 0}$ be the continuous time variable. Consider the continuous-time dynamic system $\Sigma$ defined by the equation
\begin{equation*}
